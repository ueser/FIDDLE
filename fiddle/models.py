...
class NNscaffold(object):
    ...
    def __init__(self, config, architecture_path = 'architecture.json', learning_rate = 0.01, batch_norm = False, model_path = '../results/example'):
        """Initiates a neural network scaffold with default values
    ...
    def train(self, train_data, accuracy = None, inp_dropout = 0.1, batch_size = 128, gating = False):
        ...
        if train_data == []:
            ...
            if gating:
                ...
                train_feed.update({self.common_predictor.all_gates: np.ones((batch_size, len(self.architecture['Inputs']))) + 0.})
...
class CommonContainer():
    def __init__(self, architecture, dropout = 1., keep_prob_input = None, inp_size = None, batch_norm = False, strand = 'Single', unified = True):
        self.architecture = architecture
    ...
    def combine_representations(self):
        ...
        with tf.variable_scope('scaffold'):
            ...
            if gating: #TODO: not sure I understand the whole gating thing...
