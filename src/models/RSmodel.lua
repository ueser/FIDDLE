...
finalNout = 500
nfeats = 1 -- for sense and antisense for NSMS and should be 4 for DS
width = 500
height = 1
...
-- 1st Layer --
m11 = nn.SpatialConvolutionMM(nfeats,nstates[1],filtSizeW[1],filtSizeH[1])(RSinp):annotate{
